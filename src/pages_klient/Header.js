    ...
    return (
        <div className="header_pc flex flex-row justify-center items-center border-b-2 border-gray ">
            ...
            <div className="blocs_header_pc flex flex-row ml-12">
                <div className="bloc_header_pc" onClick={() => navigate('/PersonalDetails')}>
                ...
                <div className="bloc_header_pc mx-8" onClick={() => navigate('/favorites')}>
                    <img 
                ...
                <div className="bloc_header_pc " onClick={() => navigate('/Cart')}>
