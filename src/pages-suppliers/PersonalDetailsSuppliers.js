    ...
    return (
        <div className="flex h-[700px] " >
            <div className="meny_personal_area border-r-2 border-gray w-[350px] h-fll py-14 px-8">
                ...
                <div className="a2 text-xl mb-8" onClick={() => window.location.href='cart_edit.html'}>Загрузка прайс-листа</div>
                <div className="a2_activ text-xl mb-8" onClick={() => window.location.href='purchases.html'}>Входящие предложения</div>
                <div className="a2 mb-8 text-xl" onClick={() => window.location.href='delivery.html'}>Оплата от маркета</div>
        ...
        <div className=" px-10 py-10">
            <div className=" mb-10">
                ...
                <div className="flex flex-row">
                    <div className=" w-[367px] h-[97px] border-2 border-gray rounded-2xl  flex flex-row justify-center items-center">
